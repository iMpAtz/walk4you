...
8. SMTP_USERNAME
9. SMTP_PASSWORD
10. YOLO_MODEL_PATH=(path fo your model)
11. YOLO_CONFIDENCE_THRESHOLD=(model confidence threshold format = 0.x)
12. YOLO_ENABLED=(true/false)
13. ALLOWED_ORIGINS=yourfrontendaddress
